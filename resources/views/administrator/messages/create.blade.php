                    ...
                    <div class="dt-card">
                        ...
                        <div class="dt-card__header">
                            ...
                            <div class="dt-card__heading">
                                <h3 class="dt-card__title"> Message Registration Form</h3>
                            </div>
                            <!-- /card heading -->
                                ...
                                <div class="form-row">
                                    <div class="col-sm-3 mb-3">
                                        ...
                                        <input type="text" class="form-control" id="validationDefault01"
                                            placeholder="Enter Message Title" required name="title" value="{{old('title')}}">
                                        @if ($errors->has('title'))
                                    ...
                                    <div class="col-sm-3 mb-3">
                                        ...
                                        <input type="text" class="form-control" id="validationDefault01"
                                            placeholder="Enter Preacher Name"  value="{{old('preacher')}}" required name="preacher">
                                    ...
                                    <div class="col-sm-3 mb-3">
                                        ...
                                        <select name="program_category_id" class="form-control" required>
                                            ...
                                            <option  value="{{old('program_category_id')}}"> {{old('program_category_name')}}</option>
                                    ...
                                    <div class="col-sm-3 mb-3">
                                        ...
                                        <input type="text" class="form-control" id="validationDefault01"
                                            placeholder="Enter Message Audio or Video Link"  value="{{old('message_link')}}" name="message_link">
                                    ...
                                    <div class="col-sm-12 mb-3">
                                        ...
                                        <textarea class="form-control" id="validationDefault01"
                                            placeholder="Enter Bible Verses" required name="bible_verses" style="height:60px"> {{old('bible_verses')}} </textarea>
                                    ...
                                    <div class="col-sm-12 mb-3">
                                        <button class="btn btn-primary btn-lg btn-block text-uppercase" type="submit">Add The Message</button>
                                    </div>
                                </div>
