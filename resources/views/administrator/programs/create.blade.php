                    ...
                    <div class="dt-card">
                        ...
                        <div class="dt-card__header">
                            ...
                            <div class="dt-card__heading">
                                <h3 class="dt-card__title">Program Registration Form</h3>
                            </div>
                            <!-- /card heading -->
                        ...
                        <div class="dt-card__body">
                            ...
                            <form action="{{route('program.save')}}" method="POST" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                <div class="form-row">
                                    <div class="col-sm-4 mb-3">
                                        <label for="validationDefault02">Program Name</label>
                                        <input type="text" class="form-control" id="validationDefault01"
                                            placeholder="Enter Program Name" required name="program_name">
                                    ...
                                    <div class="col-sm-4 mb-3">
                                        ...
                                        <div class="input-group date" id="date-time-picker-1"
                                            ...
                                            <input type="text" class="form-control datetimepicker-input"
                                                   data-target="#date-time-picker-1"/ name="program_date" required>
                                    ...
                                    <div class="col-sm-4 mb-3">
                                        ...
                                        data-target-input="nearest">
                                            <input type="text" class="form-control datetimepicker-input"
                                                    data-target="#date-time-picker-3" required name="start_time">
                                    ...
                                    <div class="col-sm-4 mb-3">
                                        ...
                                        <input type="time" class="form-control" required name="end_time" placeholder="11:30 PM">
                                    ...
                                    <div class="col-sm-4 mb-3">
                                        ...
                                        <textarea type="text" class="form-control" id="validationDefault01" style="height:50px"
                                            placeholder="Enter Ministers Name seperated by coma" required name="ministers">
                                        </textarea>
                                    ...
                                    <div class="col-sm-12 mb-12">
                                        <button class="btn btn-primary btn-lg btn-block text-uppercase" type="submit">Add The Program </button>
                                    </div>
                                </div>
